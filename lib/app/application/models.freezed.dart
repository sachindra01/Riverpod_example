...
class _$PostTearOff {
  ...
  _Post call({int? id, int? userId, String? title, String? body}) {
    return _Post(
      id: id,
      userId: userId,
      title: title,
...
class _$_Post implements _Post {
  const _$_Post({this.id, this.userId, this.title, this.body});
...
abstract class _Post implements Post {
  const factory _Post({int? id, int? userId, String? title, String? body}) =
      _$_Post;
...
class _$AlbumTearOff {
  ...
  _Album call({int? id, int? userId, String? title}) {
    return _Album(
      id: id,
      userId: userId,
      title: title,
...
class _$_Album implements _Album {
  const _$_Album({this.id, this.userId, this.title});
...
abstract class _Album implements Album {
  const factory _Album({int? id, int? userId, String? title}) = _$_Album;
